...
use crate::{
    instruction::{
        accounts::{
            ...
            CreateV1Accounts, ManageAuthLockV1Accounts, MigrateToWalletAddressV1Accounts,
...
pub fn process_action(
    ...
    match ix {
        ...
        SwigInstruction::ManageAuthLockV1 => {
            process_manage_auth_lock_v1(accounts, account_classification, data)
        },
    }
}
...
/// Processes a ManageAuthLockV1 instruction.
///
/// Manages authorization locks for a Swig wallet.
fn process_manage_auth_lock_v1(
    accounts: &[AccountInfo],
    account_classification: &[AccountClassification],
    data: &[u8],
) -> ProgramResult {
