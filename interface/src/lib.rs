...
impl UpdateAuthorityInstruction {
    ...
    /// Replace all actions for an authority using Secp256k1 signature.
    pub fn replace_all_with_secp256k1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Add new actions to an existing authority using Secp256k1 signature.
    pub fn add_actions_with_secp256k1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Remove actions by their discriminator/type using Secp256k1 signature.
    pub fn remove_actions_by_type_with_secp256k1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Remove actions by their index positions using Secp256k1 signature.
    pub fn remove_actions_by_index_with_secp256k1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Legacy method for backward compatibility using Secp256k1 (maps to replace_all).
    pub fn new_with_secp256k1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
    ...
    /// Replace all actions for an authority using Secp256r1 signature.
    pub fn replace_all_with_secp256r1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Add new actions to an existing authority using Secp256r1 signature.
    pub fn add_actions_with_secp256r1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Remove actions by their discriminator/type using Secp256r1 signature.
    pub fn remove_actions_by_type_with_secp256r1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Remove actions by their index positions using Secp256r1 signature.
    pub fn remove_actions_by_index_with_secp256r1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        current_slot: u64,
    ...
    /// Legacy method for backward compatibility using Secp256r1 (maps to replace_all).
    pub fn new_with_secp256r1_authority<F>(
        swig_account: Pubkey,
        payer: Pubkey,
        mut authority_payload_fn: F,
        ...
        F: FnMut(&[u8]) -> [u8; 64],
    {
        ...
        data_to_be_signed_bytes.extend_from_slice(&action_bytes);
